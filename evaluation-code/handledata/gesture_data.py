...
class GestureData:
    ...
    def set(self, obj: dict):
        valid_keys = ["resistance", "sample_rate", "duration", "samples", "data",
                      "candidate", "hand", "gesture_type", "target_gesture", "timestamp"]
        for key in obj:
    ...
    def change_name(self, candidate:str = "Unknown Candidate"):
        self.candidate = candidate
    ...
    def plot(self, show=True, candidate=None, target_gesture=None) -> None:
        ...
        fig.text(0.1, 0.05, 'Resistance: ' +
                 str(self.resistance / 1000) + 'kOhm')
